package com.manisoft.scraprushapp.ui.customer.locationpicker
...
import com.manisoft.scraprushapp.ui.customer.profile.address.ConfirmAddressBottomSheet
...
class LocationPickerActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private fun setClickListeners() {
        binding.btnConfirm.setOnClickListener {
            ConfirmAddressBottomSheet(selectedGeoResult).show(this.supportFragmentManager, "ConfirmAddressBottomSheet")
        }
        ...
        try {
            mFusedLocationProviderClient?.getCurrentLocation(CurrentLocationRequest.Builder().setPriority(Priority.PRIORITY_HIGH_ACCURACY).build(), null)?.addOnCompleteListener { task ->
                if (task.isSuccessful) {
                    ...
                    Log.d("Exception", "getDeviceLocation: " + task.exception?.message)
                }
            }
