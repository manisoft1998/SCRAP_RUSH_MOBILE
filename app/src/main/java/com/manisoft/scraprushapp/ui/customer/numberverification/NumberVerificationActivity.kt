package com.manisoft.scraprushapp.ui.customer.numberverification
...
import com.manisoft.scraprushapp.ui.customer.otpverification.OTPVerificationActivity
...
//        initDebug()
    ...
    private fun setClickListeners() {
        ...
        binding.tvPrivacyPolicy.setOnClickListener {
            PrivacyPolicyDialog(this@NumberVerificationActivity).showPrivacyPolicyDialog()
        }
        binding.tvTermsAndConditions.setOnClickListener {
            TermsAndConditionsDialog(this@NumberVerificationActivity).showTermsAndConditionsDialog()
        }
    }
